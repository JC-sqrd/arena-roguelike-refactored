...
func build_modifier(context : Dictionary[StringName, Variant]) -> StatModifier:
	var mult_modifier : MultiplierStatModifier = MultiplierStatModifier.new(Stats.DefinedStats.keys()[stat_id], value_provider_template.build_value_provider(context))
