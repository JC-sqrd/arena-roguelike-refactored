...
func spawn_hit_box_scene(hitbox_scene : PackedScene, parent_node : Node2D, spawn_position : Vector2, effects : Array[Effect], context : Dictionary[StringName, Variant], coll_layer : int = 0, coll_mask : int = 0):
